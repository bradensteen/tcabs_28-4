...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4221314939ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=customer_management_system&table=customer">`customer_management_system`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=customer_management_system&table=user">`customer_management_system`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tcabs663_tcabs&table=user">`tcabs663_tcabs`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tcabs663_tcabs&table=role">`tcabs663_tcabs`.`role`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=investment&table=country">`investment`.`country`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=management_system&table=user">`management_system`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6045735a38315f55247335674b5e5e3f">
