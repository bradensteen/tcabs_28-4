...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1010344626ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tcabs663_tcabs&table=user">`tcabs663_tcabs`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=customer_management_system&table=user">`customer_management_system`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tcabs663_tcabs&table=role">`tcabs663_tcabs`.`role`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=customer_management_system&table=customer">`customer_management_system`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=investment&table=country">`investment`.`country`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=management_system&table=user">`management_system`.`user`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5830697549442f49244255573b224875">
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="customer_management_system" targettable="user">
            ...
            Database
                            : <span>customer_management_system</span>
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="customer_management_system" targettable="customer">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `user` (`user_id`, `user_name`, `user_password`) VALUES (&#039;1&#039;, &#039;braden&#039;, &#039;admin123&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="customer_management_system" targettable="user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="tcabs663_tcabs" targettable="user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE PROCEDURE GetAllUsers()
BEGIN
	SELECT *  FROM user;
END;</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="tcabs663_tcabs" targettable="role">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="tcabs663_tcabs" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE PROCEDURE ListAllUsersByID (puid TEXT)
BEGIN

SELECT uID, uFName, uSName FROM user
WHERE uID = puID;
...
END;</span>
            ...
            Queried time
                            ...
                            <span class="query">CALL ListAllUsersByID(1);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="tcabs663_tcabs" targettable="">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE PROCEDURE InsertUser(pfname TEXT, psname TEXT, pbirthday DATE, pmobile TEXT, pemail TEXT, prole TEXT, ppassword TEXT)
BEGIN
   INSERT INTO USER (uFName, uSName, birthday, uMobile, uEmail, rID, pWord) VALUES ( pfname, psname, pbirthday, pmobile, pemail, prole, ppassword);
END;</span>
                        </div>
